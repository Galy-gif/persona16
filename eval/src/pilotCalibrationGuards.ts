...
const CASH_PREDICATE_ONLY = /^(?:(?:你觉得[，,\s]*)?(?:那|它|那它)?[，,\s]*)?(?:(?:能|可以)?(?:撑|扛|维持).{0,8}(?:多久|几天|几周|几个月|到什么时候)(?:(?:的?(?:基本开支|生活费|房租|开销))|不(?:饿肚子|挨饿|欠房租|欠账|逾期|工作|上班)(?:[、]不(?:饿肚子|挨饿|欠房租|欠账|逾期|工作|上班)){0,2})?|够(?:不够)?(?:你)?(?:(?:什么都不干|暂时不工作|完全不工作|不工作|不去上班|先休息|只休息|休息|没有(?:工资|收入|进账)|(?:完全)?不进账|一分钱不赚|不(?:拿|领|收)[^，,。！？!?\n；;]{0,6}(?:工资|收入|钱))(?:地)?)?(?:撑|扛|维持).{0,8}(?:多久|几天|几周|几个月|到什么时候)(?:(?:不慌|不焦虑|不发愁|不出问题|不工作)|不(?:拿|领|收).{0,12}(?:工资|收入|钱))?|(?:能|可以)?让你(?:(?:什么都不干|暂时不工作|完全不工作|不工作|不去上班|先休息|只休息|休息|没有(?:工资|收入|进账)|(?:完全)?不进账|一分钱不赚|不(?:拿|领|收)[^，,。！？!?\n；;]{0,6}(?:工资|收入|钱))(?:地)?)?(?:撑|扛|维持).{0,8}(?:多久|几天|几周|几个月|到什么时候)(?:(?:不慌|不焦虑|不发愁|不出问题|不工作)|不(?:拿|领|收).{0,12}(?:工资|收入|钱))?|(?:(?:能|可以)?|够(?:不够)?(?:你)?)(?:撑|扛|维持)到(?:下一次|下次|下一笔)(?:必须|需要)?(?:进账|到账|发工资)(?:(?:的)?(?:时间|时候)|之前)?(?:吗)?|(?:够不够|怎么办|怎么付|哪笔|多久|覆盖不了|断掉|没着落|付不起))$/;
