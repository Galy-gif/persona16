...
import { createRoom, defaultConfig, runTurn } from '@persona16/engine';
import { engineDependencies } from './shared'; // 加载 dotenv
...
async function main() {
  ...
  const result = await runTurn(
    room,
    '我最近很想辞职，但又怕后悔。',
    { roomId: 'eval-smoke-room', promptVersion: 'phase1-engine-smoke-v1' },
    config,
