...
export type TurnStreamEvent =
  ...
  | (VersionedTurnEvent & { type: 'mutter'; agent: AgentType; text: string })
  | (VersionedTurnEvent & { type: 'delta'; agent: AgentType; delta: string })
  | (VersionedTurnEvent & { type: 'speaker_end'; messageId: string; agent: AgentType; speechType: SpeechType; text: string; mutter?: string })
